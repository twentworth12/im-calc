        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold text-white">incident.io</span>
            </div>
            <p className="text-gray-400 text-sm mb-4">
              The all-in-one incident management platform for modern engineering teams.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="text-gray-400 hover:text-white">Incident response</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white">On-call management</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white">Status pages</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white">Workflows</a></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-sm text-gray-400">
              © 2024 incident.io. All rights reserved.
            </div>
